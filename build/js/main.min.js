...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    form.init();
    window.form = form;
    var inputsPhone = document.querySelectorAll('[data-validate-type="phone"]');
...
if (about) {
  var paragraphs = about.querySelectorAll('p');
...
var menuItems = document.querySelectorAll('.accordion');
if (menuItems) {
  menuItems.forEach(function (item, number) {
    if (number > 0) {
